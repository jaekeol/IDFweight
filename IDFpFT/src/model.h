...
class Model {
  ...
  public:
    ...
    void update(const std::vector<int32_t>&, const std::vector<float> &, int32_t, real);
    void computeHidden(const std::vector<int32_t>&, Vector&) const;
    void computeHidden(const std::vector<int32_t>&, Vector&, bool, bool) const;
    void computeHidden(const std::vector<int32_t>&, const std::vector<float>&, Vector&, bool, bool) const;
    ...
    void computeHidden2_mv(const std::vector<int32_t>&, const std::vector<float>&, Vector&) const;
